...
public class PanelLogin extends JPanel {
    ...
    public PanelLogin()
    {
        ...
        btnLogin.addActionListener(e -> {
            ...
            if (oUser.isPresent()) //znalazlo usera o takich danych jaka podalas w panelu logowania
            {
                generateMainWindow();
            }
            else
        ...
        panelFields.setBackground(new Color(255,255,140));
        panelOperations.setBackground(new Color(255,255,140));
